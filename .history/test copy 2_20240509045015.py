...
def update(frame):
    ...
    if frame*accurancy < act_radius+act_radius*act_n anollllllllllllllllllllllllllllllllllllllllllllllllppooo;pppan:   #直线运动 frame从0开始所以小一个accurancy单位切换
        action=LINE
    ...
    elif frame*accurancy == act_radius+act_radius*act_n:
        act_n=act_n+1
