...
ax.set_xlim(-circle_time+center_x, circle_time+center_x)
ax.set_ylim(-circle_time+center_y, circle_time+center_y)
ax1.set_xlim(-circle_time+center_x, circle_time+center_x)
ax1.set_ylim(0, 400)
ax2.set_xlim(-circle_time+center_x, circle_time+center_x)
ax2.set_ylim(-circle_time+center_y, circle_time+center_y)
ax3.set_xlim(-circle_time+center_x, circle_time+center_x)
ax3.set_ylim(-circle_time+center_y, circle_time+center_y)
# 计算圆形轨迹的点
circle_time=10000  #画完一个圈时间
