...
update_partial = functools.partial(update,accurancy=accurancy point=point, trajectory_line=trajectory_line,radius=radius,center_x=center_x, center_y=center_y)
# 创建动画对象
