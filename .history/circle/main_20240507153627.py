...
init_partial = functools.partial(init, ax=ax,point=point,trajectory_line=trajectory_line,ex_radius=ex_radius,center_x=, center_y=)
update_partial = functools.partial(update, point=point, trajectory_line=trajectory_line,radius=,center_x=center_x, center_y=)
# 创建动画对象
