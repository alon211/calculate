...
init_partial = functools.partial(init, ax=ax,ani=ani,tool_r=tool_dpoint=point,trajectory_line=trajectory_line,ex_radius=ex_radius,center_x=center_x, center_y=center_y)
