...
# 更新函数，用于动画的每一帧
def update(frame,max_frames,tool_r,accurancy,point, trajectory_line,radius,center_x, center_y):
    global last_action,action,act_line,act_angle,act_n,x
