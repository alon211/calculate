...
init_partial = functools.partial(init, ax=ax,ani=ani,tool_r=tool_r/2.0point=point,trajectory_line=trajectory_line,ex_radius=ex_radius,center_x=center_x, center_y=center_y)
