...
update_partial = functools.partial(update,max_frames=max_frames,accurancy=accurancy, point=point, trajectory_line=trajectory_line,radius=radiu,center_x=center_x, center_y=center_y)
# 创建动画对象
