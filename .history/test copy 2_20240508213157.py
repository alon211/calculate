...
def update(frame):
    ...
    if frame*accurancy < act_radius+act_radius*act_n-accurancy :   #直线运动 frame从0开始所以小一个accurancy单位切换
        ...
        y = center_y
        action=LINE
    elif frame*accurancy >= act_radius+act_radius*act_n-accurancy and frame<act_radius+act_radius*(act_n+1): #圆运动
